...
void VehicleConfigHelper::Init() {
  ...
  vehicle_config_.vehicle_param.front_edge_to_center = 3.89;
  vehicle_config_.vehicle_param.back_edge_to_center = 1.043;
  vehicle_config_.vehicle_param.left_edge_to_center = 1.055;
  vehicle_config_.vehicle_param.right_edge_to_center = 1.055;
  vehicle_config_.vehicle_param.length = 4.933;
  vehicle_config_.vehicle_param.width = 2.11;
  vehicle_config_.vehicle_param.height = 1.48;
  vehicle_config_.vehicle_param.min_turn_radius = 5.05386147161;
  vehicle_config_.vehicle_param.max_steer_angle = 8.20304748437;
  vehicle_config_.vehicle_param.max_steer_angle_rate = 8.55211;
  vehicle_config_.vehicle_param.steer_ratio = 16;
  vehicle_config_.vehicle_param.wheel_base = 2.8448;
